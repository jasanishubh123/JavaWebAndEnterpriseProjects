...
@Inject SecurityContext securityContext;
   ...
   if(securityContext.isCallerInRole("AdminAdmin"))
 {
   //  objHttpServletResponse.setHeader("Authorization", authtoken);
   System.out.println("Authorizations :"+req.getHeader("Authorization"));
     System.out.println("Principal = "+ securityContext.getCallerPrincipal().getName());
    res.sendRedirect("/JWTEnterprise_Demo-war/admin.jsp");
 
 }
    else if(securityContext.isCallerInRole("SupervisorSupervisor"))
    {
    res.sendRedirect("/JWTEnterprise_Demo-war/users.jsp");
    }
    else
      res.sendRedirect("/JWTEnterprise_Demo-war/loginError.jsp");
