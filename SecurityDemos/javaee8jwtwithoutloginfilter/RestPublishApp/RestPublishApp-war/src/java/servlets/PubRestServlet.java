...
// Retrieve All data 
      ...
      if(!res.getStatusInfo().getReasonPhrase().equals("Forbidden"))
      {
            ...
            {
                        out.println("<h3> Id ="+ c.getCustomerID()+ " Name = " + c.getFirstName() + " "+ c.getLastName() + "</h3>");
            ...
            {
                           out.println("<h3>Id ="+ addres.getAddressId()+ " Name = " + addres.getCity() + " "+ addres.getState() + "</h3>");
            ...
            {
                           out.println("<h3>Name = " + s.getTitle()+ " "+ s.getType() + "</h3>");
