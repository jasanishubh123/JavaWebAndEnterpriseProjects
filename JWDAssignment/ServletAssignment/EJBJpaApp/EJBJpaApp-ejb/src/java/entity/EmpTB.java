...
@NamedQueries({
    ...
    @NamedQuery(name = "EmpTB.findByDepartmentID", query = "SELECT e FROM EmpTB e WHERE e.departmentID = :departmentID")})
public class EmpTB implements Serializable {
    ...
    public EmpTB( String employeeName, String password, int departmentID) {
       // this.empID = empID;
