...
//    GenericType<Collection<EmpTB>> gemps;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
//            Collection<EmpTB> emps = el.getEmps();
//            for(EmpTB e : emps){
//                out.println(e.getEmployeeName());
//            }
            //out.println("<h1>Servlet ttp at " + request.getContextPath() + "</h1>");
...
//
//            for (EmpTB e:Emps){
//                out.println("<h2>"+e.getEmployeeName()+" "+e.getPassword()+"</h2>");
//            }
