...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name="EmpTB.findAllWithDeptName",query = "SELECT e.EmployeeName,e.Password,e.Salary,d.DepartmentName FROM EmpTB e,DeptTB d WHERE e.DepartmentID=d.DepartmentID"),
